...
export class wallet1674457221353 implements MigrationInterface {
  name = 'wallet1674457221353';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "wallet" ("id" SERIAL NOT NULL, "usd" integer NOT NULL, CONSTRAINT "PK_bec464dd8d54c39c54fd32e2334" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
